 ...
 */
registerBlockType( 'coronalaw/block-question', {
	// Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
	title: __( 'Frage' ), // Block title.
	...
	edit: (props) => {
		...
		const ALLOWED_BLOCKS = ['coronalaw/block-choice'];
		// console.log(props);
		
		return (
            <article className={ props.className + " decision-tree__question" }>
                ...
                <div className="decision-tree__question__body">
                    <InnerBlocks 
